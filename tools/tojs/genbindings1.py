...
def main():
    ...
    cocos_root = os.path.abspath(os.path.join(project_root, '..', 'cocos2d-js/frameworks/js-bindings/cocos2d-x'))
    cxx_generator_root = os.path.abspath(os.path.join(project_root, '..', 'cocos2d-js/tools/bindings-generator'))
