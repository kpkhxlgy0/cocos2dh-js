...
#include "../../helper/native/CCNative.h"
#include "jni/Java_org_cocos2dxh_lib_Cocos2dxhHelper.h"
...
const string HNative::getOpenUDID() {
    return getOpenUDIDJNI();
}

string HNative::generateUuid() {
    return generateUuidJNI();
}
