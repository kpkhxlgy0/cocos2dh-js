#ifndef  __PLATFORM_IOS_HSTOREIMPLWIN32__
#define  __PLATFORM_IOS_HSTOREIMPLWIN32__

#include "../../quick/store/HStoreImpl.h"

NS_CC_H_BEGIN

class HStoreImplWin32 : public HStoreImpl, public CCStoreTransactionObserver {
public:
    ~HStoreImplWin32();
...
#endif // __PLATFORM_IOS_HSTOREIMPLWIN32__
